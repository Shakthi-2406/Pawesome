                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="posting.php" class="nav-item nav-link active">Post a pet</a>
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpeg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Posting Pet 🐕🐇</h1>
                </div>
            </div>
        </div>
        <!-- Page Header End -->
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Pet Posting 🐕🐶</h6>
                    <h1 class="mb-5">Help your pet find a <span class="text-primary text-uppercase">Better Soul</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="postAdd.php" method="post" enctype="multipart/form-data">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="breed" id="name" placeholder="Your Name">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" name="price" id="email" min="1" max="1000000" placeholder="Your Email">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating date" id="date3" data-target-input="nearest">
                                            <input type="number" class="form-control" name="years" min="0" max="20" id="checkin" placeholder="Check In" data-target="#date3"/>
                                            <label for="checkin">Age (only years)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating date" id="date4" data-target-input="nearest">
                                            <input type="number" class="form-control" id="checkout" name="months" min="0" max="11" placeholder="Check Out" data-target="#date4" />
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit">Put it up for sale</button>
                                    </div>
                                </div>
                            </form>
                        </div>
