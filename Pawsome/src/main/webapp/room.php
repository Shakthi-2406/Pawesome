...
<head>
    ...
    <script>
        function filter() {
          var str = document.getElementById("filterId").value;  
          if (str != ""){
            ...
            xmlhttp.open("GET", "postGetFilter.php?q=" + str, true);
            xmlhttp.send();
          }
          else return;
        }

        function getOwnerDetail(btn){
            var petname = btn.getAttribute('petname');
            var time = btn.getAttribute('time');
            var uname = btn.getAttribute('uname');
            var type = btn.getAttribute('type');
            var target = document.getElementById("modalBox");
            ...
            xmlhttp.open("GET", "postGetOwner.php?petname=" + petname + "&time=" + time + "&uname=" + uname + "&type=" + type, true);
            xmlhttp.send();
...
<body>
    <div>
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="room.php" class="nav-item nav-link active">Pets</a>
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpeg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Pets 🐶</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Pets</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="container">
                <div class="bg-white shadow" style="padding: 35px;">
                    <div class="row g-2">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-primary w-100" onclick="filter()">Filter</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- ModalBox Start -->
        <!-- <div id="closeBtn" onclick="console.log(document.getElementById('modalBox'))" >&times;</div> -->
