        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h1>Cannot proceed further. Login or Sign up please!</h1>
                    <br>
                    <a href="http://localhost:8081/Pawsome/login.jsp" class="btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block">Log in / Sign Up<i class="fa fa-arrow-right ms-3"></i></a>
                </div>
            </div>
        </div>
